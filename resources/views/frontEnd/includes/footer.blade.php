                            ...
                            <div>
                                ...
                                <a
                                        href="tel:{{ Helper::GeneralSiteSettings("contact_t3") }}"><span
                                            dir="ltr">{{ Helper::GeneralSiteSettings("contact_t3") }}</span></a></div>
                        @endif
                        @if(Helper::GeneralSiteSettings("contact_t4") !="")
                            <div>
                                <strong>{{ trans('frontLang.callFax') }}:</strong> &nbsp;
                                <a
                                        href="tel:{{ Helper::GeneralSiteSettings("contact_t4") }}"><span
                                            dir="ltr">{{ Helper::GeneralSiteSettings("contact_t4") }}</span></a></div>
                        @endif
                ...
                @if(count($LatestNews)>0)
                    ...
                    <div class="col-lg-{{$bx2w}}">
                        <div class="widget">
                            ...
                            <ul class="link-list footer-news">
