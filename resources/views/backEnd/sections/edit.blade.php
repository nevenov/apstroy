                    ...
                    <div class="box-body">
                        ...
                        @if(Helper::GeneralWebmasterSettings("it_box_status"))
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('title_it',$Sections->title_it, array('placeholder' => '','class' => 'form-control','id'=>'title_it','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("it_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_title_it',$Sections->seo_title_it, array('class' => 'form-control','id'=>'seo_title_it','maxlength'=>'65', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    @if(Helper::GeneralWebmasterSettings("it_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::text('seo_url_slug_it',$Sections->seo_url_slug_it, array('class' => 'form-control','id'=>'seo_url_slug_it', 'dir'=>trans('backLang.ltr'))) !!}
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if(Helper::GeneralWebmasterSettings("it_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_description_it',$Sections->seo_description_it, array('class' => 'form-control','id'=>'seo_description_it','maxlength'=>'165', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                    @endif
                                    @if(Helper::GeneralWebmasterSettings("it_box_status"))
                                        <div class="form-group">
                                            <div>
                                                ...
                                                {!! Form::textarea('seo_keywords_it',$Sections->seo_keywords_it, array('class' => 'form-control','id'=>'seo_keywords_it', 'dir'=>trans('backLang.ltr'),'rows'=>'2')) !!}
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <div class="col-sm-6">
                                    @if(Helper::GeneralWebmasterSettings("it_box_status"))
                                        <?php
                                        $seo_example_title = $Sections->title_it;
                                        $seo_example_desc = Helper::GeneralSiteSettings("site_desc_it");
                                        if ($Sections->seo_title_it != "") {
                                            $seo_example_title = $Sections->seo_title_it;
                                        }
                                        if ($Sections->seo_description_it != "") {
                                            $seo_example_desc = $Sections->seo_description_it;
                                        }
                                        if ($Sections->seo_url_slug_it != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                            $seo_example_url = url($Sections->seo_url_slug_it);
                                        } else {
                                            $seo_example_url = route('FrontendTopicsByCat', ["section" => $Sections->webmasterSection->name, "cat" => $Sections->id]);
                                        }
                                        ?>
