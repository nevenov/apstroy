...
return [
    ...
    'connectEmailToConnect' => 'Свържи с webmail акаунт',
    'connectEmail' => 'Email',
    'connectPassword' => 'Парола',
    'openWebmail' => 'Отвори Webmail',
    ...
    'oops' => 'OOPS',
    'noPermission' => "Sorry! Нямате права за да отворите страницата.",
    'notFound' => "Страницата неможе да бъде намерена.",

    // Sign In
    'forgotPassword' => 'Забравена парола?',
    'signIn' => 'Влез',
    'keepMeSignedIn' => 'Запомни ме',
    'signedInToControl' => 'Влизане в администрацията',
    'control' => 'Админ',
    'resetPassword' => 'Нулиране на парола',
    'confirmPassword' => 'Потвърди паролата',
    'newPassword' => 'Нова парола',
    'yourEmail' => 'Твоя Email',
    'sendPasswordResetLink' => 'Изпращане на линк за нулиране на паролата',
    'returnTo' => 'Върни се обратно',
    'enterYourEmail' => 'Въведете имейл адреса си по-долу и ние ще ви изпратим инструкции как да промените паролата си.',
    ...
    'cashClearMsg' =>'Наистина ли искате да изчистите кеш и временни файлове?',
    'cashClearDone' =>'Успешно изчистени кеш и временни файлове',
